...
exports.responseMessage = {
    ...
    appleAccountError: "Your account has been deleted,Please remove account from Setting > Your account > Password & Security > Apps using Apple ID > Dating app > Click to stop using Apple ID",
